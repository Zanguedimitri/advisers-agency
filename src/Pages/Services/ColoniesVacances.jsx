...
export function ColoniesVacances() {
  return (
    <div>
      ...
      {/*  */}
      <section className="flex flex-col items-center p-25 gap-y-5">
        ...
        <p className="text-justify text-lg  pl-20 pr-20">
          Advisers Agency et ses partenaires vous proposent des camps d’été
          thématiques et non thématiques avec à la clé la création d'un réseau
          d'amis venant du monde entier, qu'ils sauront valoriser dans le futur
          proche. De plus, les participants interagissent avec d'autres pairs de
          différents pays et apprennent les bases d'une langue seconde de leur
          choix pendant les camp. Le leadership, le réseautage, le
          divertissement, l’athlétisme et l'apprentissage sont les piliers qui
          sous tendent les camps de vacances que nous vous proposons.
        </p>
      </section>
      {/*  */}
      <section>
        <div className="grid grid-cols-2 grid-rows-2 p-30 gap-0 justify-items-center text-white">
          {/* grid1 */}
