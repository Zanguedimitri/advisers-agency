...
const SummerCamps = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
                ...
                <table className="min-w-full bg-white rounded-lg overflow-hidden">
                  <thead className="bg-green-100 text-green-800">
                    <tr>
                      ...
                      <th className="py-3 px-4 text-left">Prix (F CFA)</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-700">
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">01 semaine</td>
                      <td className="py-3 px-4">590.000 - 760.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">02 semaines</td>
                      <td className="py-3 px-4">1.000.000 - 1.280.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">03 semaines</td>
                      <td className="py-3 px-4">1.500.000 - 1.600.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">04 semaines</td>
                      <td className="py-3 px-4">1.840.000 - 1.950.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">05 semaines</td>
                      <td className="py-3 px-4">2.300.000 - 2.400.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">06 semaines</td>
                      <td className="py-3 px-4">2.790.000 - 2.900.000</td>
                    </tr>
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                      <td className="py-3 px-4">07 semaines</td>
                      <td className="py-3 px-4">3.200.000 - 3.300.000</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="py-3 px-4">08 semaines</td>
                      <td className="py-3 px-4">3.580.000 - 3.680.000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        {activeTab === "accommodation" && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p className="mb-6">Nous proposons deux types d'hébergement:</p>
            ...
            <div className="mt-8 text-center">
              <button className="bg-blue-900 hover:bg-blue-900 text-white font-bold py-3 px-8 rounded-full cursor-pointer shadow-md transition-colors">
      ...
      <div className="p-4">
        <button className="bg-blue-900 hover:bg-blue-900 w-12 h-12 text-white font-bold flex justify-center items-center cursor-pointer active:animate-ping p-8 rounded-full shadow-md transition-colors">
